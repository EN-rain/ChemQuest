...
const REQUIRED_QUEST := "separation_methods_after"
const ACTIVE_QUEST_ID := "accuracy_vs_precision"
...
func interact() -> void:
	...
	await FadeManager.fade_and_change("res://games/chapter_one/hometown/building_one/Level4/PrecisionAccuracy/precision_accuracy.tscn")
