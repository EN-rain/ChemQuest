...
var placed_atoms: Array = [] # store {sym, node}
...
func _delayed_next_round() -> void:
	...
	# ✅ Re-enable atoms and confirm button
...
func _end_game() -> void:
	...
	# ⚗️ Lesson 2 counter
	LessonManager.increment_run_two_and_check_reset()
